    ...
    <div className="flex-1 flex flex-col min-h-0 overflow-y-auto pr-2 custom-scrollbar space-y-4">
      ...
      <div className="flex gap-4 p-1 rounded-2xl w-fit">
        <button
          ...
          className={`flex items-center gap-2 px-8 py-3 rounded-xl text-xs font-black uppercase tracking-widest transition-all ${view === 'receive'
        ...
        <button
          ...
          className={`flex items-center gap-2 px-8 py-3 rounded-xl text-xs font-black uppercase tracking-widest transition-all ${view === 'history'
              ? 'bg-emerald-600 text-white shadow-lg shadow-emerald-600/20'
              : 'text-gray-400 hover:text-gray-600 bg-gray-50'
            }`}
        >
              ...
              <table className="w-max min-w-full text-left">
                <thead>
                  <tr className="text-[10px] font-black text-gray-400 uppercase tracking-widest border-b border-gray-50 whitespace-nowrap">
                    ...
                    <th className="px-6 py-5 whitespace-nowrap">Verification Result</th>
                    <th className="px-6 py-5 text-center whitespace-nowrap">Discrepancies</th>
                    <th className="px-6 py-5 text-center whitespace-nowrap">Final Accepted Qty</th>
        ...
        <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-sm p-8 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            {[
              ...
              <div key={stat.label} className={`p-6 rounded-[2rem] border border-gray-100 shadow-sm flex flex-col items-center justify-center gap-1 ${stat.color === 'emerald' ? 'bg-emerald-50/30' :
                  stat.color === 'rose' ? 'bg-rose-50/30' :
                    stat.color === 'amber' ? 'bg-amber-50/30' :
                      stat.color === 'orange' ? 'bg-orange-50/30' : 'bg-gray-50/30'
                }`}>
                <span className={`text-2xl font-black ${stat.color === 'emerald' ? 'text-emerald-600' :
              ...
              <table className="w-max min-w-full text-left">
                <thead>
                  <tr className="text-[9px] font-black text-gray-400 uppercase tracking-widest border-b border-gray-50 whitespace-nowrap">
                    ...
                    <th className="px-4 py-4 text-center whitespace-nowrap">Ordered</th>
                    <th className="px-4 py-4 text-center whitespace-nowrap">Received</th>
                    <th className="px-4 py-4 text-center whitespace-nowrap">Accepted</th>
                    <th className="px-4 py-4 text-center whitespace-nowrap">Damaged</th>
                    <th className="px-4 py-4 text-center whitespace-nowrap">Expiry</th>
                    <th className="px-4 py-4 text-center whitespace-nowrap">Missing</th>
                    <th className="px-4 py-4 text-right whitespace-nowrap sticky right-0 bg-white z-10 shadow-[-10px_0_10px_-3px_rgba(0,0,0,0.05)]">Final Status</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-50">
                  {selectedReport.items?.map(item => (
                    <tr key={item.id} className="text-xs font-bold text-gray-900 whitespace-nowrap">
                      ...
                      <td className="px-4 py-6 text-center">
                        <span className={`px-2 py-0.5 rounded text-[8px] font-black uppercase ${item.expiryStatus === 'SAFE' ? 'bg-emerald-50 text-emerald-600' :
                      ...
                      <td className="px-4 py-6 text-right sticky right-0 bg-white z-10 shadow-[-10px_0_10px_-3px_rgba(0,0,0,0.05)]">
                        <span className="px-3 py-1 bg-emerald-50 text-emerald-600 border border-emerald-100 rounded-full text-[9px] font-black uppercase tracking-widest">
                          Accepted
                        </span>
                      </td>
