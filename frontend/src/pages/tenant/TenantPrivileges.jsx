...
const MODULES = [
  { key: 'DASHBOARD', label: 'Dashboard', desc: 'Overview & analytics', categories: ['ADMIN', 'AGENT', 'SUPERVISOR'] },
  { key: 'INVENTORY', label: 'Inventory', desc: 'Stock & products', categories: ['ADMIN', 'AGENT', 'SUPERVISOR'] },
  { key: 'SALES', label: 'Sales', desc: 'Order management', categories: ['ADMIN', 'AGENT'] },
  { key: 'VEHICLES', label: 'Vehicles', desc: 'Fleet management', categories: ['ADMIN', 'HELPER'] },
  { key: 'STAFF', label: 'Staff', desc: 'User management', categories: ['ADMIN', 'SUPERVISOR'] },
  { key: 'ROUTES', label: 'Routes', desc: 'Route planning', categories: ['ADMIN', 'AGENT', 'SUPERVISOR', 'HELPER'] },
  { key: 'CASH', label: 'Cash Flow', desc: 'Cash reconciliation', categories: ['ADMIN', 'AGENT', 'SUPERVISOR'] },
          ...
          {roles.map((role) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 bg-gray-50 rounded-2xl p-3">
                ...
                <div className="flex-1 text-center">
                  <span className="text-lg font-black text-blue-600">{role._count?.users || 0}</span>
